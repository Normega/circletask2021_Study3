...
demographicsHTML =  '	<!-- ####################### Demographics ####################### -->' +
 ...
 '                your ID. As long as you finish the experiment you will get ' +
...
var demographics_trial = {
    ...
    on_finish: function(data){       
        ...
        if(data.response.gender == "" ||
            ...
            //console.log(data.response);       
            pData.Gender  = data.response.gender;
            pData.Age  = data.response.age;
            pData.Language  = data.response.language;
            pData.Country  = data.response.country;             
        }        
    }
};
...
var demographics_node ={
    ...
    loop_function: function(){                
        if(goodDemographics){            
            saveSessionData2("questionnaire_Demographics");
            pData.TrialNum = 0;
            return false; //exit loop
        } else {  
            currentHTML = demographicsHTML + 
             '<p><b>Please respond to all of the questions above to proceed.</b></p>';
            //console.log("Bad ID");
